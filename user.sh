...
printf "\e[1;92m[\e[0m\e[1;77m>\e[0m\e[1;92m] Checking username\e[0m\e[1;77m %s\e[0m\e[1;92m : \e[0m\n" $username
...
check1=$(curl -s -i "https://linkedin.com/id/$username" -H "Accept-Language: en" -L | grep -o 'profile:username' ; echo $?)

if [[ $check1 == *'1'* ]] ; then 
printf "\e[1;93mNot Found!\e[0m\n"
elif [[ $check1 == *'0'* ]]; then 

printf "\e[1;92m Found!\e[0m https://linkedin.com/id/" $username
printf "https://linkedin.com/id/" $username >> $username.txt
fi

## Tracky

printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] NGL: \e[0m"
check1=$(curl -s -i "https://ngl.link/$username" -H "Accept-Language: id" -L --user-agent '"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:0.9.3) Gecko/20010801"' | grep -o 'Do you want to register' ; echo $?)
if [[ $check1 == *'1'* ]] ; then 
printf "\e[1;93mNot Found!\e[0m\n"
elif [[ $check1 == *'0'* ]]; then 

printf "\e[1;92m Found!\e[0m https://ngl.link/" $username
printf "https://ngl.link/" $username >> $username.txt
fi
...
check_twitter=$(curl -s "https://x.com/$username" -L -H "Accept-Language: en" | grep -o 'page doesn’t exist'; echo $?)
...
check1=$(curl -s -i "https://tiktok.com/@$username" -H "Accept-Language: en" -L | grep -o 'profile:username' ; echo $?)

if [[ $check1 == *'1'* ]] ; then 
printf "\e[1;93mNot Found!\e[0m\n"
elif [[ $check1 == *'0'* ]]; then 

printf "\e[1;92m Found!\e[0m https://tiktok.com/@" $username
printf "https://tiktok.com/@" $username >> $username.txt
fi
